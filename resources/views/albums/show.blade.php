    ...
    <div class="container">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted mb-1">
                {{ __('By') }}: <a href="{{ route('artists.show', $album->artist) }}">{{ $album->artist->stage_name }}</a>
            </p>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    <div class="bg-light p-3 rounded shadow-sm">
                        <strong>{{ __('Average Rating') }}:</strong><br>
                        @if ($averageRating)
                            @php
                                $score = $averageRating;
                                $stars = floor($score / 2);
                ...
                @auth
                    <div class="col-md-6">
                        <div class="bg-light p-3 rounded shadow-sm">
                            <strong>{{ __('Your Rating') }}:</strong><br>
                            @php
                            ...
                            @else
                                <span class="text-muted">{{ __('You havent rated this album yet.') }}</span>
                            @endif
                        </div>
                    </div>
                @endauth
        ...
        @auth
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-md-6">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title">{{ __('Rate this Album') }}</h5>
        ...
        {{-- Reviews Section --}}
        <div>
            <h4 class="mb-3">{{ __('User Reviews') }}</h4>
            ...
            @empty
                <p class="text-muted">{{ __('No reviews yet. Be the first to review this album!') }}</p>
            @endforelse
        </div>
    </div>
</x-layout>
